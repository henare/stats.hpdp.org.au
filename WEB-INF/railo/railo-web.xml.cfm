<?xml version="1.0" encoding="UTF-8"?><railo-configuration password="cf54bb14a8396cf14c7cf19b0c8561b5519a2cc203e34442b431efd42e4c818f" version="2.0"><cfabort/>
...
-->
    ...
    arguments:
	 ...
	 -->
	<setting close-connection="no" show-version="yes" suppress-whitespace="no"/>
...
<!--	or ask your database distributor 																-->
	...
	<data-source allow="511" blob="false" class="org.gjt.mm.mysql.Driver" clob="false" connectionTimeout="1" custom="zeroDateTimeBehavior=convertToNull&amp;CharacterEncording=UTF8" database="stats" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" name="pool" password="Ieso5Eek" port="3306" username="stats"/></data-sources>
	...
	<!--
		...
		tld-directory / fld-directory - directory where addional Function and Tag Library Deskriptor are.
	...
	-->
	<scope applicationtimeout="1,0,0,0" cascade-to-resultset="yes" cascading="standard" client-directory="{railo-web}/client-scope/" client-directory-max-size="100mb" clientmanagement="no" merge-url-form="no" requesttimeout="0,0,0,50" requesttimeout-log="{railo-web}/logs/requesttimeout.log" sessionmanagement="yes" sessiontimeout="0,0,30,0" setclientcookies="yes" setdomaincookies="no"/>
...
<error status-code="true" template-404="/railo-context/templates/error/error.cfm" template-500="/railo-context/templates/error/error.cfm"/></railo-configuration>