...
window.addEvent('domready', function(){
	if(!window.datepicker_options){
		datepicker_options = { 
				pickerClass:'datepicker_vista', 
				inputOutputFormat:'Y-m-d', 
				allowEmpty:true };
	}
	new DatePicker('.date_picker', datepicker_options);
});
// there are some other changes made below for hidden fields (/onlineSFS/admin/dates.cfm)
